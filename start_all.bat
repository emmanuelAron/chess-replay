...
start cmd /k "cd /d D:\eclipse_wkspace\chess-replay-parent\chess-replay-v1 && mvn exec:java -Dexec.mainClass=com.github.emmanuelAron.kafka.ChessMovesProducerLive"
